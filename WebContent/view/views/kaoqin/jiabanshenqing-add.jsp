...
<body>
	<div class="x-body">
		<form class="layui-form"
			action="${pageContext.request.contextPath}/JiabanshenqingAdd"
			method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="申请时间" name="shenqingshijian"
						id="shenqingshijian" required="" lay-verify="required" value="<%=dateFormat.format(calendar.getTime()) %>"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="加班时间" name="jiabanshijian"
						id="jiabanshijian" required="" lay-verify="required"
						autocomplete="off" type="text">
				</div>
			</div>
