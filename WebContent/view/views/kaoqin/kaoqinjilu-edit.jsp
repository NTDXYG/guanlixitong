...
<body>
	<div class="x-body">
		<form class="layui-form"
			action="${pageContext.request.contextPath}/KaoqinjiluEdit"
			method="post">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="id" name="id" required=""  readonly="readonly" value="<%=request.getParameter("id") %>"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="考勤时间" name="kaoqinshijian"
						id="kaoqinshijian" required="" lay-verify="required" value="<%=request.getParameter("kaoqinshijian")%>"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="leibie" required="" lay-verify="required">
						<option class="layui-input" value="<%=request.getParameter("leibie")%>" lay-skin="primary"><%=request.getParameter("leibie")%></option>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="kaoqinshiduan" required="" lay-verify="required">
						<option class="layui-input" value="<%=request.getParameter("kaoqinshiduan")%>" lay-skin="primary"><%=request.getParameter("kaoqinshiduan")%></option>
						<%
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					value="<%=request.getParameter("shuoming")%>"
						lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
