...
<body>
	<div class="x-body">
		<form class="layui-form"
			action="${pageContext.request.contextPath}/TiaoxiushenqingEdit"
			method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="申请时间"value="<%=request.getParameter("shenqingshijian")%>"
						name="shenqingshijian" id="shenqingshijian" required=""
			...
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>调休时间（起）
				</label>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="调休时间（起）" name="begin"
					value="<%=request.getParameter("begin") %>"
						id="begin" required="" lay-verify="required" autocomplete="off"
						type="text">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>调休时间（讫）
				</label>
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="调休时间（讫）" name="end"
					value="<%=request.getParameter("end") %>"
						id="end" required="" lay-verify="required" autocomplete="off"
						type="text">
				</div>
			</div>
			...
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>调休时长
				</label>
				<div class="layui-input-inline">
					<input type="text" id="tiaoxiushichang" name="tiaoxiushichang"
					value="<%=request.getParameter("tiaoxiushichang") %>"
						required="" lay-verify="tiaoxiushichang" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>调休原因
				</label>
				<div class="layui-input-inline">
					<input type="text" id="tiaoxiuyuanyin" name="tiaoxiuyuanyin" required=""
					value="<%=request.getParameter("tiaoxiuyuanyin") %>"
						lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
	...
	layui.use([ 'form', 'layer', 'laydate' ], function() {
		...
		form.verify({
			tiaoxiushichang : [ /^(\d)+(\.\d{1})$/, '请填写小数点后1位' ]
		});
