	...
	<div class="layui-card">
		...
		<div class="x-body">
			...
			<button class="layui-btn"
				onclick="x_admin_show('添加假期申请','${pageContext.request.contextPath}/view/views/kaoqin/jiaqishenqing-add.jsp')">
				...
				<tbody>
					<c:forEach items="${pageBean.jiaqishenqingList}"
						...
						<tr>
							...
							<td>${jiaqishenqing.staff_name}</td>
							...
							<td class="td-manage"><a onclick="member_stop(this,'10001')"
								...
								onclick="x_admin_show('编辑','${pageContext.request.contextPath}/view/views/kaoqin/jiaqishenqing-edit.jsp?id=${jiaqishenqing.id}&staff_name=${jiaqishenqing.staff_name }&kaishishijian=${jiaqishenqing.kaishishijian}&jieshushijian=${jiaqishenqing.jieshushijian}&shichang=${jiaqishenqing.shichang}&jiaqileixing=${jiaqishenqing.jiaqileixing}&yuanyin=${jiaqishenqing.yuanyin}')"
								href="javascript:void(0);"> <i class="layui-icon">&#xe642;</i>
							</a> <a title="删除" onclick="member_del('${jiaqishenqing.id}')"
								href="javascript:void(0);"> <i class="layui-icon">&#xe640;</i>
							</a></td>
						</tr>
					</c:forEach>
			...
			<div class="page">
				<div>
					...
					<c:if test="${pageBean.currentPage!=1 }">
						<a class="prev"
							href="${pageContext.request.contextPath }/JiaqishenqingList?currentPage=${pageBean.currentPage-1 }">&lt;&lt;</a>
					</c:if>
