...
<body>
	<div class="x-body">
		<form class="layui-form"
			action="${pageContext.request.contextPath}/ChuchaishenqingAdd"
			method="post">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" placeholder="出差时间" name="chuchaishijian"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="chuchaitianshu" name="
						chuchaitianshu" required="" lay-verify="chuchaitianshu" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<%
						for (Staff s : staff) {
					%>
					<input type="checkbox" name="tongxingrenyuan" title="<%=s.getName()%>"
						value="<%=s.getName()%>">
					<%
						}
					%>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="mudidi" name="mudidi" required=""
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="shiyou" name="shiyou" required=""
						lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			</div>
