	...
	<div class="layui-card">
		...
		<div class="x-body">
			...
			<button class="layui-btn"
				onclick="x_admin_show('添加加班申请','${pageContext.request.contextPath}/view/views/kaoqin/jiabanshenqing-add.jsp')">
			...
			<table class="layui-table">
				...
				<tbody>
					<c:forEach items="${pageBean.jiabanshenqingList}"
						var="jiabanshenqing">
						<tr>
							<td>
							...
							<td>${jiabanshenqing.staff_name}</td>
							...
							<td class="td-manage"><a onclick="member_stop(this,'10001')"
								...
								onclick="x_admin_show('编辑','${pageContext.request.contextPath}/view/views/kaoqin/jiabanshenqing-edit.jsp?id=${jiabanshenqing.id}&staff_name=${jiabanshenqing.staff_name}&shenqingshijian=${jiabanshenqing.shenqingshijian}&jiabanshijian=${jiabanshenqing.jiabanshijian}&jiabanshichang=${jiabanshenqing.jiabanshichang}&yuanyin=${jiabanshenqing.yuanyin}')"
								href="javascript:void(0);"> <i class="layui-icon">&#xe642;</i>
							</a> <a title="删除" onclick="member_del('${jiabanshenqing.id}')"
								href="javascript:void(0);"> <i class="layui-icon">&#xe640;</i>
							</a></td>
						</tr>
					</c:forEach>
			...
			<div class="page">
				<div>
					...
					<c:if test="${pageBean.currentPage!=1 }">
						<a class="prev"
							href="${pageContext.request.contextPath }/JiabanshenqingList?currentPage=${pageBean.currentPage-1 }">&lt;&lt;</a>
					</c:if>
